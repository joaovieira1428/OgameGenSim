...
public class BattleBenchmark
{
    ...
    public async Task GlobalSetupAsync()
    {
        ...
        List<string> attackers = [attacker1, attacker1];

        List<string> defenders = [defender1, defender1];

        DirtyCombatInformation dirtyData = await loader.LoadCombatInformation(attackers, defenders);
